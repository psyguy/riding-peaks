  ...
  mutate(
    ...
    correlation_type =
      factor(
        ...
        labels = c(
          "Pearson's linear-linear correlation",
          "Spearman's linear-linear rank correlation",
          "Kendall's linear-linear rank correlation",
          "Johnson–Wehrly–Mardia circular-linear correlation",
          "Mardia's rank circular-linear correlation"
        )
      )
  ) %>%
